...
Unblock-File .\scripts\ga\validate-lga-06-limited-ga-operational-continuity-capacity-upgrade-preparation.ps1
Unblock-File .\scripts\security\scan-local-secrets.ps1
Unblock-File .\scripts\posdashboard\validate-posdashboard-operations-dashboard.ps1

.\scripts\ga\validate-lga-06-limited-ga-operational-continuity-capacity-upgrade-preparation.ps1 `
  ...
  -WpfVisualConfirmed `
  -SkipDashboardBuild `
  -SkipLga05Revalidation
```

Expected result:

```text
PASS LGA-06 LIMITED GA OPERATIONAL CONTINUITY AND CAPACITY UPGRADE PREPARATION / CONTINUE LIMITED GA
```
