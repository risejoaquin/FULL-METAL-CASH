...
```powershell
.\scripts\beta\validate-beta-08-customer-acceptance-validation.ps1 `
...
Expected final line:
`[BETA-08] BETA-08 PASS BETA CUSTOMER ACCEPTANCE VALIDATION / GO BETA-09`
