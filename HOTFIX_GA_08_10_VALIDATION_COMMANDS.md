# HOTFIX GA-08.10 Validation Commands
...
Select-String .\scripts\ga\validate-ga-08-security-tenant-isolation-access-control-final-gate.ps1 -Pattern "GA-08.10-atomic-refresh-guardrail-alignment"
...
Expected validator source guardrail:

```text
[GA-08] Validator version GA-08.10-atomic-refresh-guardrail-alignment
[GA-08] Repository/document/source GA-08 guardrails PASS
```

Expected GA-08 close:
