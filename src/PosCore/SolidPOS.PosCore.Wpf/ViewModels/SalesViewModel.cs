...
public sealed class SalesViewModel : ViewModelBase
{
    ...
    public ICommand AddAmericanoCommand { get; }

    public ICommand IncreaseQuantityCommand { get; }

    public ICommand ClearCartCommand { get; }

    public ICommand TakeCashPaymentCommand { get; }

    public ICommand QueueFakeReceiptCommand { get; }

    public ICommand MarkSyncedCommand { get; }
