...
public sealed class JwtTokenService : ITokenService
{
    ...
    public string CreateRefreshToken()
    {
        ...
        // Production refresh tokens are transported through JSON clients, proxies, shells,
        // and validation scripts. Base64Url avoids '+', '/', and '=' padding characters
        // that can be corrupted by non-JSON-safe tooling while preserving 512 bits of entropy.
