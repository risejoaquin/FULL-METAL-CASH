...
public interface IAuthRepository
{
    ...
    Task<AuthenticatedUser?> FindUserByRefreshTokenHashAsync(Guid? tenantId, string refreshTokenHash, CancellationToken cancellationToken);

    Task<AuthenticatedUser?> RotateRefreshTokenAndFindUserAsync(Guid tenantId, string oldRefreshTokenHash, string newRefreshTokenHash, DateTimeOffset newExpiresAt, CancellationToken cancellationToken);

    Task<bool> RotateRefreshTokenAsync(Guid tenantId, string oldRefreshTokenHash, string newRefreshTokenHash, DateTimeOffset newExpiresAt, CancellationToken cancellationToken);

    Task RevokeRefreshTokenAsync(Guid? tenantId, string refreshTokenHash, CancellationToken cancellationToken);
}
