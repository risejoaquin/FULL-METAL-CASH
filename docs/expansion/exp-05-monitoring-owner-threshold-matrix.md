...
| failed requests | Backend owner | delta = 0 during validation window | cumulative baseline >0 retained as historical condition | delta >0 during validation window | inspect logs | observability metrics baseline + delta |
