# HOTFIX GA-12.1 Validation Commands
...
Select-String .\scripts\ga\validate-ga-12-final-general-availability-launch-readiness.ps1 -Pattern "GA-12.1-document-contract-activation-wording"
...
```text
[GA-12] Repository/document GA-12 guardrails PASS
[GA-12] GA-12 evidence manifest and final readiness snapshot PASS
