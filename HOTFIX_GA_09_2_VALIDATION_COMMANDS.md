# SolidPOS — Hotfix GA-09.2 validation commands
...
Select-String .\scripts\ga\validate-ga-09-performance-capacity-resilience-offline-readiness.ps1 -Pattern "GA-09.2-httpclient-concurrency-latency-measurement"
```
...
```text
[GA-09] Validator version GA-09.2-httpclient-concurrency-latency-measurement
```
